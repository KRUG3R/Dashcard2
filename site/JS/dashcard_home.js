...
var theUrl = 'http://34.207.67.225:8080/transacao/totaisHora' 
...
{
    var xmlHttp = new XMLHttpRequest();
    var theUrl = 'http://34.207.67.225:8080/transacao/totais' 
    xmlHttp.open( "GET", theUrl, false ); 
    xmlHttp.send( null );
    if(xmlHttp.status!=200){
      window.location.replace("index.html");
...
{
    var xmlHttp = new XMLHttpRequest();
    var theUrl = 'http://34.207.67.225:8080/transacao/totaisComparativo' 
    xmlHttp.open( "GET", theUrl, false ); 
    xmlHttp.send( null );
    if(xmlHttp.status!=200){
      window.location.replace("index.html");
...
{
    var xmlHttp = new XMLHttpRequest();
    var theUrl = 'http://34.207.67.225:8080/agentes/' 
    xmlHttp.open( "GET", theUrl, false ); 
    xmlHttp.send( null );
    if(xmlHttp.status!=200){
      window.location.replace("index.html");
